...
public class Week02BooleanConditionalsLoopsLab {
	...
	public static void main(String[] args) {
		...
		double costOfMilk = 5.50; int thirstLevel = 8;
		if (costOfMilk < 2.5) {
		...
		int numberOfCookies = 10; int numberOfChildren = 4;
		...
		System.out.println(loyaltyMemberStatus + " is " + loyaltyMemberDiscount);
		...
		double billTotal = 78.5; double adjustedTotal = billTotal - loyaltyMemberDiscount * billTotal / 100;
		
		if (adjustedTotal > 500) {
			if (loyaltyMemberDiscount == 0.10) {
				
				loyaltyMemberStatus = "GOLD";
			}
			
			else if (loyaltyMemberDiscount == 0.15) {
		...
		String username = "john123"; String password = "pass";
